...
/**
 * @author zahab
 * Class used for listening the available wi-fi direct peers.
 * Implements WifiP2pManager.PeerListListener which gives a callback onPeersAvailable 
	...
	public void onPeersAvailable(WifiP2pDeviceList peerList) {
		...
		if (peers.size() == 0) {
			...
			for(int i = 0; i<items.size();i++){
				...
				Log.d(TAG,"Device name " + device.deviceName + "Device Address " + device.deviceAddress);
			}
		}
